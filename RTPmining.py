...
# Determines whether a pattern is RTP or not based on DEFINITION 4
...
# calculating support of a recent temporal pattern using DEFINITION 6
def RTP_support(P, g):						
	RTPlist = []
...
def pattern_mining(D, g, support):
	one_RTP = []
	freq_states = TemporalAbstraction.find_all_frequent_states(D, support)
